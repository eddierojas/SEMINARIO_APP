...
import com.example.usuarios_yya.databinding.ActivityRegistrationBinding
...
class RegistrationAct : AppCompatActivity() {
            ...
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    db.collection("users").document(uid).set(map).addOnSuccessListener {
                        infoUser(email, ProviderType.BASIC)
    ...
    private fun infoUser(email: String, provider:ProviderType) {
